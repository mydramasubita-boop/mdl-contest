 ...
 *
 * Gli utenti con isAdmin:true su Firestore saltano sia il controllo giorno
 * sia il blocco "già completata" — utile per testare le missioni senza
 * dover continuamente cambiare contestConfig.startDate o creare utenti nuovi.
 *
...
async function checkMissionAccess(uid, missionDay, missionKey){
  ...
  if(userData && userData.isAdmin){
    return { canPlay: true, isAdminBypass: true };
  }
